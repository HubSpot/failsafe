...
public class ExecutionOld extends AbstractExecutionOld {
   ...
   */
  public ExecutionOld(RetryPolicy retryPolicy) {
   ...
   */
  public ExecutionOld(RetryPolicy retryPolicy, CircuitBreaker circuitBreaker) {
    super(new FailsafeConfig<Object, FailsafeConfig<Object, FailsafeConfig<Object, ?>>>().with(retryPolicy)
        .with(circuitBreaker));
  }

  ExecutionOld(FailsafeConfig<Object, ?> config) {
    super(config);
  }
