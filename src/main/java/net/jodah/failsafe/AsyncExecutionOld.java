...
@Deprecated
public final class AsyncExecutionOld extends AbstractExecutionOld {
  private final Callable<Object> callable;
  private final FailsafeFutureOld<Object> future;
  private final Scheduler scheduler;
  volatile boolean completeCalled;
  volatile boolean retryCalled;

  @SuppressWarnings("unchecked")
  <T> AsyncExecutionOld(Callable<T> callable, Scheduler scheduler, FailsafeFutureOld<T> future,
                     FailsafeConfig<Object, ?> config) {
    super(config);
    this.callable = (Callable<Object>) callable;
    this.scheduler = scheduler;
    this.future = (FailsafeFutureOld<Object>) future;
  }
  ...
  /**
   * Attempts to complete the execution and the associated {@code FutureResult} withMigration the {@code result}. Returns true on
  ...
  /**
   * Attempts to complete the execution and the associated {@code FutureResult} withMigration the {@code result} and
