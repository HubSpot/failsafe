 ...
 * {@link ScheduledExecutorService} associated withMigration the Failsafe call.
 *
...
public class AsyncFailsafeConfig<R, F> extends FailsafeConfig<R, F> {
   ...
   */
  public F onSuccessAsync(CheckedBiConsumer<? extends R, ExecutionContextOld> listener) {
