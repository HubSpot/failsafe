...
public class Listeners<R> {
   ...
   * Called when an execution is aborted.
   */
  public void onAbort(R result, Throwable failure, ExecutionContextOld context) {
  }
   ...
   * Called when an execution is completed.
   */
  public void onComplete(R result, Throwable failure, ExecutionContextOld context) {
  }
   ...
   * Called when an execution attempt fails.
   */
  public void onFailedAttempt(R result, Throwable failure, ExecutionContextOld context) {
  }
   ...
   * Called when an execution fails and cannot be retried.
   */
  public void onFailure(R result, Throwable failure, ExecutionContextOld context) {
  }
   ...
   * Called before an execution is retried.
   */
  public void onRetry(R result, Throwable failure, ExecutionContextOld context) {
  }
   ...
   * Called when an execution is successful.
   */
  public void onSuccess(R result, ExecutionContextOld context) {
  }
  ...
  static <T> ContextualResultListener<T, Throwable> of(
    ...
    return new ContextualResultListener<T, Throwable>() {
      @Override
      public void onResult(final T result, final Throwable failure, final ExecutionContextOld context) {
  ...
  static <T> ContextualResultListener<T, Throwable> of(final CheckedConsumer<? extends Throwable> listener) {
    ...
    return new ContextualResultListener<T, Throwable>() {
      @Override
      public void onResult(T result, Throwable failure, ExecutionContextOld context) throws Exception {
  ...
  static <T> ContextualResultListener<T, Throwable> ofResult(
      final CheckedBiConsumer<? extends T, ExecutionContextOld> listener) {
    Assert.notNull(listener, "listener");
    return new ContextualResultListener<T, Throwable>() {
      @Override
      public void onResult(T result, Throwable failure, ExecutionContextOld context) throws Exception {
        ((CheckedBiConsumer<T, ExecutionContextOld>) listener).accept(result, context);
      }
    };
  }
}