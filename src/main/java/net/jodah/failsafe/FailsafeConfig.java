...
public class FailsafeConfig<R, F> {
   ...
   */
  public F onSuccess(CheckedBiConsumer<? extends R, ExecutionContextOld> listener) {
   ...
   */
  public F onSuccessAsync(CheckedBiConsumer<? extends R, ExecutionContextOld> listener, ExecutorService executor) {
  ...
  void handleAbort(R result, Throwable failure, ExecutionContextOld context) {
  ...
  void handleComplete(R result, Throwable failure, ExecutionContextOld context, boolean success) {
    if (success)
  ...
  void handleFailedAttempt(R result, Throwable failure, ExecutionContextOld context) {
  ...
  void handleRetriesExceeded(R result, Throwable failure, ExecutionContextOld context) {
  ...
  void handleRetry(R result, Throwable failure, ExecutionContextOld context) {
  ...
  private void handleComplete(R result, Throwable failure, ExecutionContextOld context) {
  ...
  private void handleFailure(R result, Throwable failure, ExecutionContextOld context) {
  ...
  private void handleSuccess(R result, ExecutionContextOld context) {
