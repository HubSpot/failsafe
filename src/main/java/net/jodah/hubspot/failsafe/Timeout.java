...
/**
 * A policy that fails an excecution with a {@link TimeoutExceededException TimeoutExceededException}
...
public class Timeout<R> extends PolicyListeners<Timeout<R>, R> implements Policy<R> {
   ...
   * <ul>
   *   <li>
   * Executions that are cancelled or interrupted after they timeout are still completed with {@link TimeoutExceededException TimeoutExceededException}.
   *   </li>
   *   <li>
