 ...
 */
package net.jodah.hubspot.failsafe.internal;

import net.jodah.hubspot.failsafe.CircuitBreaker;
import net.jodah.hubspot.failsafe.CircuitBreaker.State;
import net.jodah.hubspot.failsafe.ExecutionContext;
import net.jodah.hubspot.failsafe.internal.util.CircularBitSet;
